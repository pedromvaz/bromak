...
<html>
    ...
    <body>
        ...
        <div id="show-champion" class="content scaffold-show" role="main">
            ...
            <f:display bean="champion" />
            <g:form resource="${this.champion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.champion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
